# -*- coding: utf-8 -*-
"""
Created on Wed May 19 11:47:04 2021
...
class RRT:
    ...
    def __init__(self,
        ...
        self.min_rand = 0
        self.max_rand_x = grid.shape[0]
        self.max_rand_y = grid.shape[1]
        self.expand_dis = expand_dis
        self.path_resolution = path_resolution
        self.goal_sample_rate = goal_sample_rate
        self.max_iter = max_iter
        self.grid = grid
        self.obstacle_list = self.generate_obstaclelist()
        self.node_list = []
        

    def generate_obstaclelist(self):
        self.obstacle_list = []
...
def main(sx, sy, gx, gy, obstacleList, grid):
